...
public class Reminder {
	...
	public Reminder(int reminderId, String reminderName, String reminderDescription, String reminderType,
			String reminderCreatedBy, List<Note> noteList, Date reminderCreationDate) {
		super();
	...
	public Reminder(int i, String string, String string2, String string3, String string4, Object object, Date date) {
